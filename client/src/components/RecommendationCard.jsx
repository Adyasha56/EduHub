...
import { BookOpen, Zap, Rocket, Library, Briefcase, Clock, ExternalLink, ChevronRight, Info } from "lucide-react";

const providerMeta = {
  gemini: {
    label: "Gemini",
    tooltip: "Recommendations generated by AI based on your profile.",
  },
  groq: {
    label: "Groq",
    tooltip: "Recommendations generated by AI based on your profile.",
  ...
  "rule-based": {
    label: "Curated",
    tooltip: "Recommendations are curated based on your profile. Refresh later for AI-powered suggestions.",
  },
};
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        ...
        {provider && (
          <div className="relative group flex items-center gap-1 text-xs text-slate-400 dark:text-slate-500 cursor-default select-none">
            <span>{providerMeta[provider]?.label ?? provider}</span>
            <Info className="w-3 h-3" />
            <div className="absolute right-0 top-5 z-10 hidden group-hover:block w-64 px-3 py-2 rounded-lg bg-slate-800 text-white text-xs shadow-lg leading-relaxed">
              {providerMeta[provider]?.tooltip}
            </div>
          </div>
        )}
      </div>
